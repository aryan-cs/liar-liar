...
\midrule
\multicolumn{4}{l}{\emph{CAA} \quad ($\ell^{*}{=}\DecLayer$, $\alpha^{*}{=}\DecAlpha$, PPL ratio \DecPplRatio; baseline MC2 $= \BaseMcTwo$)} \\
\midrule
$v_{\mathrm{dec}}$ & $0.436$ & $-0.035$ & --- \\
...
\midrule
$v_{\mathrm{dec}}$ & $0.543$ & $+0.073$ & --- \\
$v^{\perp}$ al-16 & $0.539$ & $+0.069$ & $0.94$ \,{\scriptsize $[0.82,\, 1.06]$} \\
$v^{\perp}$ al-64 & $0.540$ & $+0.069$ & $0.95$ \,{\scriptsize $[0.79,\, 1.13]$} \\
$v^{\perp}$ al-256 & $0.543$ & $+0.072$ & $0.99$ \,{\scriptsize $[0.80,\, 1.27]$} \\
$v^{\perp}$ al-1024 & $0.564$ & $+0.093$ & $1.28$ \,{\scriptsize $[0.95,\, 2.05]$} \\
$v^{\perp}$ cur & $0.541$ & $+0.071$ & $0.97$ \,{\scriptsize $[0.90,\, 1.04]$} \\
$v^{\perp}$ stat & $0.551$ & $+0.080$ & $1.10$ \,{\scriptsize $[1.04,\, 1.23]$} \\
$v^{\parallel}$ al-64 & $0.502$ & $+0.032$ & $0.43$ \,{\scriptsize $[0.28,\, 0.76]$} \\
$v^{\perp}$ al-64 nm & $0.539$ & $+0.068$ & $0.93$ \,{\scriptsize $[0.77,\, 1.11]$} \\
